  ...
  return (
    <AnimatePresence>
      {scrolledPast && (
        ...
        >
          {/* WhatsApp — shares layoutId with ContactButton in HeroSection */}
          <motion.a
            ...
            className="flex items-center justify-center rounded-full p-3 sm:p-3.5 text-white outline outline-2 -outline-offset-[3px] outline-white hover:scale-[1.08] active:scale-[0.97]"
            style={{
              background:
          ...
          {/* Gmail — shares layoutId with ContactButton in HeroSection */}
          <motion.a
            layoutId="contact-email"
            href={`mailto:${EMAIL}`}
            aria-label="Send an email"
            transition={{ type: "spring", stiffness: 200, damping: 26 }}
            className="flex items-center justify-center rounded-full p-3 sm:p-3.5 outline outline-2 -outline-offset-[3px] outline-white hover:scale-[1.08] active:scale-[0.97]"
